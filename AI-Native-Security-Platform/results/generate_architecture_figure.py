...
def _box(ax, x, y, w, h, text, facecolor, edgecolor):
...
def generate_architecture_figure():
    ...
    ax.text(1.9, 4.15, "Campus Edge", ha="center", fontsize=9, fontweight="bold", color="#0D47A1")
    ax.text(5.2, 4.15, "Event Bus", ha="center", fontsize=9, fontweight="bold", color="#E65100")
    ax.text(9.25, 4.15, "Cloud Control Plane", ha="center", fontsize=9, fontweight="bold", color="#4A148C")
    ...
    ax.text(6.0, 0.25, "Closed-loop mitigation without human-in-the-loop triage", ha="center", fontsize=8, style="italic")
